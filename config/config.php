...
# What is the name of this app?
	define('APP_NAME', 'p2.visualedgedev.com');  
...
# Default DB name for this app
	define('DB_NAME', 'visualed_p2_visualedgedev_com'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'wbAA6Lv!Uw^A@wdQQhsVU^jqgyrOEicopM(E$acc');
	define('TOKEN_SALT', 'wbAA6Lv!Uw^A@wdQQhsVU^jqgyrOEicopM(E$acc');